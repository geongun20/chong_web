...
<div class="container py-3">
	...
	<section id="bo_w">
	    ...
	    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
			...
			<div class="row">
				<?php if ($is_name) { ?>
					<div class="form-group label-floating col-6">
						...
						<input type="text" class="form-control" name="wr_name" id="wr_name" value="<?php echo $name ?>" required>
					</div>
				<?php } ?>
				<?php if ($is_password) { ?>
					<div class="form-group label-floating col-6">
			...
			<div class="row">
				<div class="form-group label-floating col-6">
				    <label class="control-label" for="wr_2">연락처</label>
					<input type="text" class="form-control" name="wr_2" id="wr_2" value="<?php echo $wr_2 ?>">
				</div>
			</div>
						
			<div class="form-group label-floating">
			    <label class="control-label" for="wr_subject">상담 제목</label>
			...
			<div class="form-group label-floating">
			    <label class="control-label" for="wr_content">상담 내용</label>

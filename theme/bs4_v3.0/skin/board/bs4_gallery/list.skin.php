            ...
            <span class="sound_only">
                ...
                <div class="img-thumbnail">
                    ...
                    <?php	                    
                        ...
                        if($thumb['src']) {
                             $img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" >'; // 원본 이미지가 아닌 썸네일을 사용하도록 수정(18-12-22)
                         } else {
                    ...
                    <div class="caption">
                        <div class="caption_title"><?php echo $list[$i]['subject'] ?><?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span> +<span class="cnt_cmt"><?php echo $list[$i]['comment_cnt']; ?></span><span class="sound_only">개</span><?php } ?>

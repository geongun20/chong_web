...
/*
$ck_time = date('H'); // 글쓰기 가능 시간 설정
if($ck_time > 8 && $ck_time < 23 ){
...
<link rel="stylesheet" href="<?php echo G5_THEME_URL ?>/asset/datetimepicker/bootstrap-material-datetimepicker.css" />
<script type="text/javascript" src="http://momentjs.com/downloads/moment-with-locales.min.js"></script>
<script type="text/javascript" src="<?php echo G5_THEME_URL ?>/asset/datetimepicker/bootstrap-material-datetimepicker.js"></script>
...
-->
	...
	<div class="form-row d-flex justify-content-center mt-4">
		<?php if ($is_name) { ?>
			<div class="form-group label-floating col-sm-4 col-md-3">
	 ...
	 <div class="form-row d-flex justify-content-center">
	    <div class="form-group label-floating col-sm-4 col-md-3">
	      ...
	      <input type="text" class="form-control" name="wr_1" value="<?php echo $write['wr_1']; ?>" id="from" required>
	    </div>
	    <div class="form-group label-floating col-sm-4 col-md-3">
	      <label class="control-label" for="wr_2">종료일</label>
	      <input type="text" class="form-control" name="wr_2" value="<?php echo $write['wr_2']; ?>" id="to" required>
	    </div>
	 </div>

		
	<div class="form-group label-floating">
	    <label class="control-label" for="wr_subject">일정</label>
	...
	<div class="form-group label-floating">
	    <label class="control-label" for="wr_content">상세 내용</label>
...
<script>
$('#from').bootstrapMaterialDatePicker({ weekStart : 0, format: 'YYYYMMDD', time: false });
$('#to').bootstrapMaterialDatePicker({ weekStart : 0, format: 'YYYYMMDD', time: false });

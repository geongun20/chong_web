    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <ul class="list-group mb-4">
            	...
            	<div class="row">
	            	<div class="col-6">
						<div class="form-group">
							...
							<input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="form-control frm_input half_input <?php echo $required ?> <?php echo $readonly ?>" size="10" placeholder="이름">
							<?php
            ...
            <li class="list-group-item">
                ...
                <input type="text" name="mb_homepage" value="<?php echo get_text($member['mb_homepage']) ?>" id="reg_mb_homepage" <?php echo $config['cf_req_homepage']?"required":""; ?> class="form-control frm_input full_input <?php echo $config['cf_req_homepage']?"required":""; ?>" size="70" maxlength="255" placeholder="홈페이지">
            	</div>
            </li>
            <?php }  ?>
            ...
            <li class="list-group-item">
                ...
                <input type="text" name="mb_addr1" value="<?php echo get_text($member['mb_addr1']) ?>" id="reg_mb_addr1" <?php echo $config['cf_req_addr']?"required":""; ?> class="form-control frm_input frm_address full_input <?php echo $config['cf_req_addr']?"required":""; ?>" size="50"  placeholder="기본주소">
                <label for="reg_mb_addr1" class="sound_only">기본주소<?php echo $config['cf_req_addr']?'<strong> 필수</strong>':''; ?></label><br>
                <input type="text" name="mb_addr2" value="<?php echo get_text($member['mb_addr2']) ?>" id="reg_mb_addr2" class="form-control frm_input frm_address full_input" size="50"  placeholder="상세주소">
                <label for="reg_mb_addr2" class="sound_only">상세주소</label>
                <br>
                <input type="text" name="mb_addr3" value="<?php echo get_text($member['mb_addr3']) ?>" id="reg_mb_addr3" class="form-control frm_input frm_address full_input" size="50" readonly="readonly"  placeholder="참고항목">
        ...
        <ul class="list-group mb-4">
            ...
            <li class="list-group-item reg_mb_img_file">
            <div class="form-group">
            ...
            <div class="form-group">
            	...
            	<div class="form-check">
				  	<input type="checkbox" class="form-check-input" name="mb_mailling" value="1" id="reg_mb_mailling" <?php echo ($w=='' || $member['mb_mailling'])?'checked':''; ?>>
				  	<label for="ereg_mb_mailling">정보 메일을 받겠습니다.</label>
  				</div>
            </div>
            </li>
            ...
            <div class="form-group">
            	...
            	<div class="form-check">
					...
					<input type="checkbox" name="mb_open" class="form-check-input" value="1" <?php echo ($w=='' || $member['mb_open'])?'checked':''; ?> id="reg_mb_open">
            ...
            <div class="form-group">
                ...
                <input type="text" name="mb_recommend" id="reg_mb_recommend" class="form-control frm_input" placeholder="추천인아이디">
            </div>
            </li>
            <?php }  ?>

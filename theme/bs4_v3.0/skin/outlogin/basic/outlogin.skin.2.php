...
<section id="ol_after" class="ol">
    <header id="ol_after_hd">
        ...
        <div class="text-right">
	        <span><?php echo $nick ?>님</span>
	        <a href="<?php echo G5_BBS_URL ?>/logout.php" id="ol_after_logout" class="btn btn-secondary btn-sm">로그아웃</a>
	        <?php if ($is_admin == 'super' || $is_auth) {  ?><a href="<?php echo G5_ADMIN_URL ?>" class="btn btn-dark btn-sm">관리자</a><?php }  ?>
        </div>
    </header>

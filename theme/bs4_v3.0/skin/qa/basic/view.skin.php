...
<article id="bo_v">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li><a href="<?php echo $prev_href ?>" class="btn btn-raised btn-dark btn-sm"><i class="fa fa-angle-left" aria-hidden="true"></i> 이전글</a></li><?php } ?>
            <?php if ($next_href) { ?><li><a href="<?php echo $next_href ?>" class="btn btn-raised btn-dark btn-sm">다음글 <i class="fa fa-angle-right" aria-hidden="true"></i></a></li><?php } ?>
        </ul>
        <?php } ?>

        <ul class="bo_v_com">
            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn btn-raised btn-secondary btn-sm">수정</a></li><?php } ?>
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn btn-raised btn-secondary btn-sm" onclick="del(this.href); return false;">삭제</a></li><?php } ?>

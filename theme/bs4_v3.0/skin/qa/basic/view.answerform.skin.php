...
<section id="bo_v_ans_form">
    ...
    <div class="form-group">
                ...
                <input type="text" name="qa_subject" value="" id="qa_subject" required class="form-control" maxlength="255" placeholder="제목">
    </div>
    ...
    <div class="btn_confirm">
        <input type="submit" value="답변쓰기" id="btn_submit" accesskey="s" class="btn btn-raised btn-primary btn-sm">
    </div>
    </form>

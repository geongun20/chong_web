...
<section id="poll" style="width: 100%;">
    <header>
        <h2><i class="far fa-chart-bar" aria-hidden="true"></i> 설문조사</h2>
    ...
    <div class="poll_con">
        ...
        <div id="poll_btn">
            <a class="btn btn-secondary btn-sm" href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;">결과보기</a>
            <input type="submit" value="투표하기" class="btn btn-dark btn-sm">
        </div>
    </div>
</section>
</form>

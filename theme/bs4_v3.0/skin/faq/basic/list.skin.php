...
<div class="container pt-3">
	...
	<?php
	if ($admin_href)
	    echo '<div class="faq_admin"><a href="'.$admin_href.'" class="btn btn-primary btn-sm">FAQ 수정</a></div>';
	...
	<div id="faq_sch">
	    <form name="faq_search_form" method="get" class="form-inline">
		    <div class="form-group">
			    <label for="stx"><span class="le_20 mb-4">FAQ 검색</span></label>
				<input type="hidden" name="fm_id" value="<?php echo $fm_id;?>">
				<label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
				<input type="text" class="form-control mb-4 plr-20" name="stx" value="<?php echo $stx;?>" required id="stx" size="15" maxlength="15">
	
				<span class="ri_15 mb-4"><button type="submit" value="검색" class="btn btn-secondary btn-sm"><i class="fa fa-search" aria-hidden="true"></i> 검색</button></span>
		    </div>
	    </form>
	</div>
	...
	<div id="faq_wrap" class="faq_<?php echo $fm_id; ?>">
	    ...
	    <section id="faq_con">
	        ...
	        <ol>
	            ...
	            ?>
	            <li>
	                <h4><span class="tit_bg">Q</span><a href="#none" onclick="return faq_open(this);"><?php echo conv_content($v['fa_subject'], 1); ?></a></h4>
	                <div class="con_inner">
	                    <span class="tit_bg">A</span>
	                    <?php echo conv_content($v['fa_content'], 1); ?>
	                    <div class="con_closer"><button type="button" class="closer_btn btn btn-secondary btn-sm">닫기</button></div>
	                </div>
	            </li>
	            <?php
	            }
	...
	<?php
	if ($admin_href)
	    echo '<div class="faq_admin"><a href="'.$admin_href.'" class="btn btn-primary btn-sm mb-4">FAQ 수정</a></div>';
	?>
